...
public class KStarPath extends Path {
	...
	/**
	 * A path that is to be followed zero or more times until no more new nodes
	...
	/**
	 * 
	 * @return the path specified in the current k-star path.
	 */
	public Path getPath() {
		return this.path;
	}
	...
	/**
	 * A helper follow method. It follows this path starting at nodes in the
	 * list of pairs (temp) in the given context
	 *
	 * @param temp
	 ...
	 *         current path starting at all the nodes in temp until no more
	 *         nodes are reachable.
	 */
	...
	/**
	 * A helper followConverse method. It follows the converse of this path
	 * starting at nodes in the list of pairs (temp) in the given context
	 *
	 * @param temp
	 *            a LinkedList of Node-PathTrace pairs.
	 * @param context
	 ...
	 * 
	 * @return a LinkedList of Node-PathTrace pairs resulted from following the
	 *         converse of the path starting at all the nodes in temp until no
	 *         more nodes are reachable.
	 */
