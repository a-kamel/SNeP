...
public class Relation {
	...
	private LinkedList<InferenceTuple> fwdPaths;
	...
	public LinkedList<InferenceTuple> getFwdPaths() {
		return fwdPaths;
	}

	private void setFwdPaths(LinkedList<InferenceTuple> fwdPaths) {
		this.fwdPaths = fwdPaths;
	}

	public void addInferenceTuple(InferenceTuple inf) {
		this.getFwdPaths().add(inf);
	}
